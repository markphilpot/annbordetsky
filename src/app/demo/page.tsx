  ...
  return (
    <Section>
      ...
      <p>
        ...
        already mentioned above. Now let&apos;s see what a more complex list
        would look like.
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            really want this to look realistic. That&apos;s why I&apos;ve added
            this second list item so I actually have something to look at when
            writing the styles.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            but three is definitely not worse, and since I seem to be having no
      ...
      <p>
        ...
        don&apos;t even let you do it, but I guess since some of you goofballs
        are going to do it we have to carry the burden of at least making it
        work.
      </p>
      <ol>
        <li>
      ...
      <p>
        ...
        backticks but it is absolutely not worth the madness it would require to
        avoid it.
      </p>
      <h4>
      ...
      <p>
        ...
        <code>h6</code> in your content, Medium only supports two heading levels
        for a reason, you animals. I honestly considered using a{" "}
      ...
      <p>
        ...
        weird or unbalanced if there is a heading too close to the end of the
        document.
      </p>
      <p>
